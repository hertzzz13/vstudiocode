...
const RenewalBusinessPermitNoticetoCorrectViolation = () => {
  ...
  const columns = [
    ...
    { field: "administrative_fine", headerName: "Administrative Fine", width: 110 },
...
/*
  ...
  return (
    <Box m="15px">
      <Header title="FSIC -> Renewal Business Permit -> Notice to Correct Violation" />
      <Box sx={{ 
        width: '30%', 
        mt: -2,
...
export default RenewalBusinessPermitNoticetoCorrectViolation;