...
const NewBusinessPermitNoticetoCorrectViolation = () => {
...
/*
  ...
  return (
    <Box m="15px">
      <Header title="FSIC -> New Business Permit -> Notice to Correct Violation" />
      <Box sx={{ 
        width: '30%', 
        mt: -2,
...
export default NewBusinessPermitNoticetoCorrectViolation;